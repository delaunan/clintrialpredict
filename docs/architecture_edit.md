...
- `frontend/views/edit_trial.py` is the isolated simulation UI. `frontend/views/trial_audit.py` remains the stable deployed audit view and should stay untouched unless explicitly requested.
