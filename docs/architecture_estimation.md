...
- `frontend/data/operational_benchmarks_v1.xlsx`: optional analyst inspection export generated by the builder when needed; not a runtime artifact.
...
- Non-production audit report: removed from the final deployment-focused repository cleanup; the durable outcome is recorded below.
