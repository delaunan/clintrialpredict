...
def render_pitch_page():
    ...
    st.markdown("""
        <div class="pitch-dark-card">
            <div class="pitch-h2-full" style="color: #ffffff; line-height: 1.1; margin-bottom: 2rem;">
                Identify late-stage clinical trials at risk<br>
                <span style="color: var(--pitch-accent);">before execution begins.</span>
            </div>
            <div class="pitch-p" style="color: #e2e8f0; max-width: 800px; margin: 0 auto; font-size: 1.15rem;">
                The screening engine is trained to predict full completion or early termination in Phase II/III trials from early design-stage information.<br><br>
                Built on publicly available data from 30,000+ late-stage clinical trials, it helps identify trials at risk of early termination, classify risk tiers, and reveal trial-specific risk drivers.<br><br>
    ...
    # --- 9. HOW STRONG IS THE PREDICTION ---
