...
def diagnostics_payload(trace):
    ...
    diagnostics = {
        ...
        "repair_warning": trace.get("repair_warning") or metadata.get("validation_retry_final_error"),
        "participant_narrative_status": trace.get("participant_narrative_status"),
        "participant_narrative_warning": trace.get("participant_narrative_warning") or metadata.get("pass2_retry_final_error"),
        "workflow_timing": {
        ...
        "validation_retry_attempts": metadata.get("validation_retry_attempts"),
        "validation_retry_max_attempts": metadata.get("validation_retry_max_attempts"),
        "validation_retry_stage": metadata.get("validation_retry_stage"),
        "validation_retry_history": metadata.get("validation_retry_history"),
        "validation_retry_final_stage": metadata.get("validation_retry_final_stage"),
        "validation_retry_final_error": metadata.get("validation_retry_final_error"),
        "pass2_validation_status": metadata.get("pass2_validation_status"),
        "pass2_validation_errors": metadata.get("pass2_validation_errors"),
        "pass2_retry_attempts": metadata.get("pass2_retry_attempts"),
        "pass2_retry_validation_status": metadata.get("pass2_retry_validation_status"),
        "pass2_retry_final_error": metadata.get("pass2_retry_final_error"),
...
def build_trace_record(
    ...
    *,
    ...
    return _clean_record({
        ...
        "audit_bundle_dir": trace.get("audit_bundle_dir"),
        ...
        "status": trace.get("status"),
        "validation_status": trace.get("validation_status"),
        "xgboost_completion_outlook": trace.get("xgboost_completion_outlook"),
