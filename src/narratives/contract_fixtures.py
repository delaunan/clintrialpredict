...
def validate_contract_fixtures(fixtures: list[dict[str, Any]] | None = None) -> list[str]:
    ...
    for index, fixture in enumerate(fixtures):
        ...
        if "expected_quality_adjustment" not in expected:
            ...
            if not isinstance(adjustment, int) or adjustment < -10 or adjustment > 10:
        ...
        if "expected_quality_adjustment" in expected and "expected_final_candidate_score" in expected:
