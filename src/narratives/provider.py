...
GEMINI_RETRY_OUTPUT_TOKENS = DEFAULT_REPAIR_MAX_OUTPUT_TOKENS
...
def _pass2_repair_prompt(
    ...
    *,
    ...
    return (
        ...
        "- Remove the phrase 'pre-reality check' from participant-facing prose; use Completion Outlook or Completion Outlook score instead.\n"
        ...
        "- Use trial_score_narrative.movement_reading as Completion Outlook: Completion Outlook score from model-visible movement plus app-rated execution scale/footprint/duration evidence when material.\n"
