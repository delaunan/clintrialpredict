...
# Adapt to production notebook variables
test_results = df_train[cols_to_keep].copy()
test_results['target'] = df_train['target']
y_prob_prod = model.predict_proba(df_train[cols_to_keep])[:, 1]
test_results['risk_score_norm'] = 1.0 - (df_full_scores.loc[df_train.index, 'Clinical_Score'] / 100.0)
