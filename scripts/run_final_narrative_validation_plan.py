...
def main() -> int:
    print(
        "scripts/run_final_narrative_validation_plan.py is disabled for the Strategic Review migration. "
        "It wraps the superseded Design Confidence / Total Scenario Score eval harness. "
        "Rebuild this plan around docs/strategic_review_phase1.md before running final validation.",
        file=sys.stderr,
    )
    return 2
